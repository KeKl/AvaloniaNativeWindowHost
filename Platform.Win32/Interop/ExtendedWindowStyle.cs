...
namespace Win32
{
	...
	internal enum ExtendedWindowStyle : uint
    {
		...
		/// 	This cannot be used for child windows or if the window has a class style of either CS_OWNDC or 
		/// 	CS_CLASSDC.
		/// </summary>
		Layered = 0x00080000,
		...
		/// <summary>
		/// 	Specifies a window that paints all descendants in bottom-to-top painting order 
		...
		/// </summary>
		/// <remarks>
		/// 	With Composited set, all descendants of a window get bottom-to-top painting order 
		/// 	using double-buffering.
		/// 	Bottom-to-top painting order allows a descendent window to have translucency (alpha) and 
		/// 	transparency (color-key) effects, but only if the descendent window also has the Transparent bit 
