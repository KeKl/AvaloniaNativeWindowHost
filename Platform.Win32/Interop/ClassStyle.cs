...
namespace Win32
{
	...
	internal enum ClassStyle
	{
		...
		/// 	Therefore, the system does not send WM_PAINT messages to windows that were obscured if 
		/// 	the memory used by the bitmap has not been discarded and if other screen actions have not 
		/// 	invalidated the stored image.
		...
		/// 	This style increases the time required to display the window, because the system must first 
